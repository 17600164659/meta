...
import { NewRoomEntryModal } from "./room/NewRoomEntryModal";
import { NewRoomEntryModalMobile } from "./room/NewRoomEntryModalMobile";
import { NewMobileUi } from "./room/NewMobileUi";
...
import { PepolsDrawer } from "./custom-components/PepolsDrawer";
import { Pepols } from "./custom-components/Pepols";

import Artboard10 from '../assets/custom-assets/heads/Artboard10.png';
import Artboard1 from '../assets/custom-assets/heads/Artboard1.png';
import Artboard2 from '../assets/custom-assets/heads/Artboard2.png';
import Artboard3 from '../assets/custom-assets/heads/Artboard3.png';
import Artboard4 from '../assets/custom-assets/heads/Artboard4.png';
import Artboard5 from '../assets/custom-assets/heads/Artboard5.png';
import Artboard6 from '../assets/custom-assets/heads/Artboard6.png';
import Artboard7 from '../assets/custom-assets/heads/Artboard7.png';
import Artboard8 from '../assets/custom-assets/heads/Artboard8.png';
import Artboard9 from '../assets/custom-assets/heads/Artboard9.png';
...
const isMobileModel = isMobile || isMobileVR;
...
const modelDeleteIdMap = {};

const randomHead = () => {
    const index = Math.floor(Math.random() * headHref.length);
    const nowHead = headHref[index];
    return nowHead;
};

const headsForId = {};

const addHeadFromPeople = async people => {
    if (headsForId[people.id]) return;
    headsForId[people.id] = randomHead();
};
...
class UIRoot extends Component {
    ...
    componentDidMount() {
        ...
        // if (isMobileModel) {
        //     ReactDOM.render(
        //         <NewMobileUi history={this.props.history} {...this.props} />,
        //         document.getElementById('mobile-ui-root')
        //     )
        // }
    }
        ...
        return (
            <MoreMenuContextProvider>
                <ReactAudioContext.Provider value={this.state.audioContext}>
                    <div className={classNames(rootStyles)}>
                        ...
                        {this.props.hub && (
                            <RoomLayoutContainer
                                ...
                                viewport={
                                    <>
                                        {!isMobileModel && <Pepols
                                            mySessionId={this.props.sessionId}
                                            hubChannel={this.props.hubChannel}
                                            count={this.state.presenceCount}
                                            presences={this.props.presences}
                                            hub={this.props.hub}
                                            headsForId={headsForId}
                                            addHeadFromPeople={addHeadFromPeople}
                                            onClick={() => {
                                                this.setState({ showAllPepols: !this.state.showAllPepols });
                                            }}
                                        />}
                                        {(this.state.showAllPepols && !isMobileModel) && (
                                            <PepolsDrawer
                                                closeHandle={() => this.setState({ showAllPepols: false })}
                                                isMobile={isMobile}
                                                headsForId={headsForId}
                                                addHeadFromPeople={addHeadFromPeople}
                                                mySessionId={this.props.sessionId}
                    ...
                    {isMobileModel && <NewMobileUi toggleSidebar={(type) => this.toggleSidebar(type)} history={this.props.history} {...this.props} />}
                    {/* {isMobileModel && <Users history={this.props.history} {...this.props} />} */}
